window.showWelcome = function () {
    ...
    const msg = "ThunderBlocks is a powerful Scratch mod that compiles to Scratch. It has many new features, including:<ul><li>Making custom blocks that are custom reporters</li><li>Many new blocks, including an exponent block</li></ul>Everything then gets compiled into Scratch-compatible code. Every new block in ThunderBlocks should also work in Scratch. This allows for the creation of many complex projects easily.<br><br>Check out the block palette to see the new features.<button style='display: block;margin: 0 auto;color: white;padding: 10px 20px;background-color: darkblue;border-radius: 5px;border: none;' onclick='document.querySelector(`#tw-custom-popup-overlay`).remove();    localStorage.setItem(\"firstTime\", \"false\")'>Go</button>"
